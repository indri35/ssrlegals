...
<div id="wrap" class="clearfix">
  <div id="header-wrap">
    ...
    $linkedin_url = check_plain(theme_get_setting('linkedin_url', 'best_responsive'));
    ?>
	...
	<ul id="header-social" class="clearfix">
        ...
        <?php if ($google_plus_url): ?><li>
          <a target="_blank" title="<?php print $site_name; ?> in Google+" href="<?php print $google_plus_url; ?>"><img alt="Google+" src="<?php print base_path() . drupal_get_path('theme', 'best_responsive') . '/images/social/googleplus.png'; ?>"> </a>
        </li><?php endif; ?>
        <?php if ($linkedin_url): ?><li>
          <a target="_blank" title="<?php print $site_name; ?> in LinkedIn" href="<?php print $linkedin_url; ?>"><img alt="LinkedIn" src="<?php print base_path() . drupal_get_path('theme', 'best_responsive') . '/images/social/linkedin.png'; ?>"> </a>
        </li><?php endif; ?>
      </ul>
    </div>
    <?php endif; ?>
      ...
      <div class="flexslider-container">
        <div id="single-post-slider" class="flexslider">
          <ul class="slides">
            ...
            <li class="slide"><img src="<?php print base_path() . drupal_get_path('theme', 'best_responsive') . '/images/slide-image-4.jpg'; ?>" alt="Slide"/></li>
            <li class="slide"><img src="<?php print base_path() . drupal_get_path('theme', 'best_responsive') . '/images/slide-image-5.jpg'; ?>" alt="Slide"/></li>
          </ul><!-- /slides -->
        </div><!-- /flexslider -->
      </div>
    </div>
